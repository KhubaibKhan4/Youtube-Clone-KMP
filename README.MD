...
## Desktop
- - Simply run the command 'gradle createDistributable or ./gradlew createDistributable'
- to create Native Distributable for the Desktop Windows, MacOS, Linux, configure the target formats in the 'build.gradle.kts':
```kotlin
compose.desktop {
    application {
        mainClass = "MainKt"
